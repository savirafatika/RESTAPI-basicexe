   ...
   <div class="card my-3">
      ...
      <div class="card-body">
         <blockquote class="blockquote mb-0">
            ...
            <footer class="blockquote-footer">𝑰𝒇 𝒚𝒐𝒖’𝒓𝒆 𝒏𝒐𝒕 𝒅𝒐𝒊𝒏𝒈 𝒔𝒐𝒎𝒆 𝒕𝒉𝒊𝒏𝒈𝒔 𝒕𝒉𝒂𝒕 𝒂𝒓𝒆 𝒄𝒓𝒂𝒛𝒚, 𝒕𝒉𝒆𝒏 𝒚𝒐𝒖’𝒓𝒆 𝒅𝒐𝒊𝒏𝒈 𝒕𝒉𝒆 𝒘𝒓𝒐𝒏𝒈 𝒕𝒉𝒊𝒏𝒈𝒔. <cite title="Source Title">𝑳𝒂𝒓𝒓𝒚 𝑷𝒂𝒈𝒆</cite></footer>
         </blockquote>
      </div>
   </div>
</div>